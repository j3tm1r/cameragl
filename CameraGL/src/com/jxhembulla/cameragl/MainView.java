...
public class MainView extends GLSurfaceView {
    ...
    public class ColorChangeListener implements OnColorChangedListener {
        @Override
        public void colorChanged(int color) {
            mRenderer.takePicture();
            mRenderer.filterColor(Color.red(color), Color.green(color), Color.blue(color));
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        mRenderer.touchEvent(event.getX() / surfacewidth, event.getY() / surfaceheight);
